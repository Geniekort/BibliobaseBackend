...
work_type.data_attributes.create!(name: "title", attribute_type: "Text", validation_definition: {
  presence: {
    condition: true
  }
}).errors.inspect
work_type.data_attributes.create!(name: "language", attribute_type: "Text")
...
manifestation_type.data_attributes.create!(name: "title", attribute_type: "Text")
manifestation_type.data_attributes.create!(name: "date", attribute_type: "DateTime")
manifestation_type.data_attributes.create!(name: "document_type", attribute_type: "Text")
manifestation_type.data_attributes.create!(name: "language", attribute_type: "Text")
...
item_type.data_attributes.create!(name: "title", attribute_type: "Text")
...
digitized_copy_type.data_attributes.create!(name: "title", attribute_type: "Text")
digitized_copy_type.data_attributes.create!(name: "format", attribute_type: "Text")
digitized_copy_type.data_attributes.create!(name: "url", attribute_type: "Text")
